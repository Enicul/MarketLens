...
class ScraperConfig:
    ...
    storage_state_path: Optional[str] = "cookies/state.json"  # persist full session by default
...
class TwitterScraper:
    ...
    async def _navigate_and_wait(self, page: Page, url: str):
        ...
        try:
            await page.wait_for_selector('article [data-testid="tweetText"]', timeout=45_000)
        except Exception:
            await page.wait_for_selector('main[role="main"] article', timeout=45_000)
